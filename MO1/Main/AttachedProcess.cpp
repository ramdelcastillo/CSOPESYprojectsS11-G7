...
AttachedProcess::AttachedProcess(int pid, std::string processName) : pid(pid), processName(processName), currentLineOfInstruction(0), processState(READY), startOrEndTime(std::time(nullptr)) {
