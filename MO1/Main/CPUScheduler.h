...
class CPUScheduler {
public:
    CPUScheduler(uint32_t nCores, std::string currentSchedulingAlgo, uint32_t quantumCycles, uint32_t batchProcessFreq, uint32_t minIns, uint32_t maxIns, uint32_t delaysPerExecution);
    ...
    void updateAmountOfWorkingCores();
    void updateCores();
